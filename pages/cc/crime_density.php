...
try {
    // For county commanders, use their assigned county
    ...
    $stationInfo = ['county' => $county, 'constituency' => null];

    // Get more hotspots for county view
    $hotspots = $crimeAnalyzer->findHotspots($timeframe, 10);
