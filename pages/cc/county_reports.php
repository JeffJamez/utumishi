    ...
    try {
        switch ($reportType) {
            case 'county':
                ...
                $reportData = $reportsManager->generateCountyReport($timeframe, $county);
                $reportsManager->exportAsCSV($reportData, "county_report_{$timeframe}days_" . date('Y-m-d') . '.csv');
                break;
        }
    } catch (Exception $e) {
...
if ($reportType) {
    try {
        switch ($reportType) {
            ...
            case 'resource':
                $reportData = $reportsManager->generateResourceReport($county);
                break;

            case 'officer_performance':
                $timeframe = $_GET['timeframe'] ?? 30;
                $reportData = $reportsManager->generateOfficerPerformanceReport($timeframe, $county);
                break;

            case 'hotspots':
                $timeframe = $_GET['timeframe'] ?? 30;
                $reportData = $reportsManager->generateHotspotsReport($timeframe, $county);
                break;
        }
...
?>
      ...
      <main class="app-main">
             ...
             <div class="mb-4">
                 ...
                 <p class="text-muted">Generate comprehensive reports on crime statistics and police performance in your county</p>
            </div>
            ...
            <div class="reports-container">
                 <!-- County Crime Report Card -->
                 <div class="report-card">
                     <div class="report-header">
                         <div class="report-title">County Crime Report</div>
                     </div>
                     <div class="report-body">
                         <div class="report-description">Comprehensive analysis of crime statistics within your county</div>
                ...
                <div class="report-card">
                 ...
                 <div class="report-card">
                     ...
                     <div class="report-body">
                         <div class="report-description">County overview of officer workload and performance metrics</div>
                        <div class="report-form">
                            <form method="GET">
                ...
                <div class="report-card">
                    ...
                    <div class="report-body">
                        <div class="report-description">Identification of high-crime areas within your county requiring increased attention</div>
                        <div class="report-form">
                            <form method="GET">
            ...
            <div class="card">
                ...
                <div class="card-body" id="report-content">
                     ...
                     <?php if ($reportType === 'county'): ?>
                         <!-- County Crime Report -->
                         <div class="mb-4">
                             <h4>County Crime Report - <?php echo htmlspecialchars($reportData['period_description']); ?></h4>
                            ...
                            <div class="kpi-grid mb-4">
                                ...
                                <div class="kpi-card">
                                 ...
                                 <div class="kpi-card">
                                     <div class="kpi-value"><?php echo $reportData['overall_statistics']['affected_constituencies'] ?? 0; ?></div>
                                     <div class="kpi-label">Constituencies</div>
                                 </div>
                            </div>
                            
                             <!-- Station Breakdown -->
                             <h5>Station Performance</h5>
                             <div class="table-responsive mb-4">
                                 <table class="table">
                                     ...
                                     <tbody>
                                         <?php foreach ($reportData['station_breakdown'] as $station): ?>
                                             <tr>
                                                 <td><strong><?php echo htmlspecialchars($station['station']); ?></strong></td>
                                                 <td><?php echo number_format($station['total_cases']); ?></td>
                                                 <td><?php echo number_format($station['resolved_cases']); ?></td>
                                                 <td>
                                                     <span class="badge status-<?php echo $station['resolution_rate'] >= 70 ? 'success' : ($station['resolution_rate'] >= 50 ? 'warning' : 'danger'); ?>">
                                                         <?php echo $station['resolution_rate']; ?>%
                                                     </span>
                                                 </td>
                                                 <td><?php echo round($station['avg_resolution_time'] ?? 0, 1); ?>h</td>
                                                 <td><?php echo $station['crime_types']; ?></td>
                                             </tr>
                                         <?php endforeach; ?>
                                     </tbody>
                                 </table>
                    ...
                    <?php elseif ($reportType === 'officer_performance'): ?>
                        ...
                        <div class="mb-4">
                            <h4>Officer Performance Report</h4>
                             ...
                             <div class="kpi-grid mb-4">
                                 <div class="kpi-card">
                                     <div class="kpi-value"><?php echo number_format($reportData['county_summary']['total_officers_national'] ?? 0); ?></div>
                                     <div class="kpi-label">Total Officers</div>
                                 </div>
                                 <div class="kpi-card">
                                     <div class="kpi-value"><?php echo round($reportData['county_summary']['national_avg_case_load'] ?? 0, 1); ?></div>
                                     <div class="kpi-label">Avg Case Load</div>
                                 </div>
                                 <div class="kpi-card">
                                     <div class="kpi-value"><?php echo $reportData['county_summary']['total_overloaded'] ?? 0; ?></div>
                                     <div class="kpi-label">Overloaded Officers</div>
                                 </div>
                                 <div class="kpi-card">
                                     <div class="kpi-value"><?php echo $reportData['county_summary']['max_case_load'] ?? 0; ?></div>
                    ...
                    <?php elseif ($reportType === 'hotspots'): ?>
                        <!-- Crime Hotspots Report -->
                         <div class="mb-4">
                             <h4>County Crime Hotspots Report - <?php echo $reportData['timeframe']; ?> days</h4>
        ...
        function printReport() {
            ...
            printWindow.document.write(`
                <html>
                    ...
                    <body>
                         <h1>Kenya Police Service - County Report</h1>
